...
extension UIImageView {
    ...
    open override func updateAppearance(with themeStyle: Theme.Style, for themeAttribute: Theme.Attribute) {
        ...
        case .highlightedImage:
            self.highlightedImage = themeStyle.highlightedImage;
            
        case .isHighlighted:
            self.isHighlighted = themeStyle.isHighlighted;
            
        case .animationImages:
            self.animationImages = themeStyle.animationImages;
            
        case .highlightedAnimationImages:
            self.highlightedAnimationImages = themeStyle.highlightedAnimationImages;
            
        case .isAnimating:
            if themeStyle.isAnimating {
                self.startAnimating();
            } else {
                self.stopAnimating();
            }
